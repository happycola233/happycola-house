...
{% btns circle grid5 %}
{% cell 水水, https://www.happycola.top, /img/avatar.png %}
{% cell 水水, https://www.happycola.top, /img/avatar.png %}
{% cell 水水, https://www.happycola.top, /img/avatar.png %}
{% cell 水水, https://www.happycola.top, /img/avatar.png %}
{% cell 水水, https://www.happycola.top, /img/avatar.png %}
...
<a href='https://apps.apple.com/cn/app/哔哩哔哩-弹幕番剧直播高清视频/id736536022' class="no-text-decoration">
<i class='anzhiyufont anzhiyu-icon-bilibili'></i>
<b>哔哩哔哩</b>
{% p red, 普通版 %}
<img src='/img/posts/anzhiyu-theme-tag/bilibili.webp'>
</a>
<a href='https://apps.apple.com/cn/app/哔哩哔哩概念/id1204090346' class="no-text-decoration">
<i class='anzhiyufont anzhiyu-icon-bilibili'></i>
<b>哔哩哔哩</b>
{% p blue, 概念版 %}
<img src='/img/posts/anzhiyu-theme-tag/bilibili_concept.webp'>
</a>
{% endbtns %}
...
{% sitegroup %}
{% site 水水的小屋, url=https://www.happycola.top, screenshot=/img/Homepage_Screenshot.jpg, avatar=/img/avatar.png, description=这是一段关于这个网站的描述文字 %}
{% site 水水的小屋, url=https://www.happycola.top, screenshot=/img/Homepage_Screenshot.jpg, avatar=/img/avatar.png, description=这是一段关于这个网站的描述文字 %}
{% site 水水的小屋, url=https://www.happycola.top, screenshot=/img/Homepage_Screenshot.jpg, avatar=/img/avatar.png, description=这是一段关于这个网站的描述文字 %}
{% endsitegroup %}
...
{% image /img/posts/anzhiyu-theme-tag/Lakeside_Sunrise_3840x2160.jpg, alt=每天下课回宿舍的路，没有什么故事。 %}

2. 指定宽度：

{% image /img/posts/anzhiyu-theme-tag/Lakeside_Sunrise_3840x2160.jpg, width=400px %}

3. 指定宽度并添加描述：

{% image /img/posts/anzhiyu-theme-tag/Lakeside_Sunrise_3840x2160.jpg, width=400px, alt=每天下课回宿舍的路，没有什么故事。 %}

4. 设置占位背景色：

{% image /img/posts/anzhiyu-theme-tag/Lakeside_Sunrise_3840x2160.jpg, width=400px, bg=#1D0C04, alt=优化不同宽度浏览的观感 %}
...
![](/img/posts/anzhiyu-theme-tag/梦春酱和水水%20Nano%20Banana_2025_09_12.png)

多可爱呀🥰 {% inlineImg /img/posts/anzhiyu-theme-tag/可爱滴捏.png 150px %}
...
这是 {% inlineimage /img/posts/anzhiyu-theme-tag/inlineimage_1.webp %} 一段话。

这又是 {% inlineimage /img/posts/anzhiyu-theme-tag/inlineimage_2.gif, height=40px %} 一段话。
...
- class_name: 推荐博客
  ...
  link_list:
    - name: 水水的小屋🏡
      link: https://happycola.top/
      avatar: /img/avatar.png
      descr: 写点有趣的东东
      siteshot: /img/Homepage_Screenshot.jpg
...
- class_name: 网站
  ...
  link_list:
    - name: Youtube
      ...
      avatar: /img/posts/anzhiyu-theme-tag/youtube.png
      descr: 视频网站
    - name: Weibo
      link: https://www.weibo.com/
      avatar: /img/posts/anzhiyu-theme-tag/weibo.png
      descr: 中国最大社交分享平台
    - name: Twitter
      link: https://twitter.com/
      avatar: /img/posts/anzhiyu-theme-tag/twitter.png
      descr: 社交分享平台
{% endflink %}
...
![mermaid](/img/posts/anzhiyu-theme-tag/mermaid.png)
...
![](/img/posts/anzhiyu-theme-tag/dogeplayer_deploy.webp)
...
![](/img/posts/anzhiyu-theme-tag/dogeplayer_preview.webp)
...
```markdown
{% folding 参数（可选）, 标题 %}
![](/img/posts/anzhiyu-theme-tag/folding.webp)
{% endfolding %}
```
...
hahaha <span><img src='/img/posts/anzhiyu-theme-tag/folding_sticker.png' style='height:24px'></span>
...
{% audio https://happycola233.s3.bitiful.net/%E9%9D%92%E8%8A%B1%E7%93%B7.mp3 %}
...
![100%宽度](/img/posts/anzhiyu-theme-tag/video_preview.png)

2. 50%宽度

![50%宽度](/img/posts/anzhiyu-theme-tag/video_preview.png)

3. 25%宽度

![25%宽度](/img/posts/anzhiyu-theme-tag/video_preview.png)
...
```markdown
{% video https://blog.domain.cn/img/posts/02-anzhiyu-theme-tag/IMG_0341.mov %}
```
